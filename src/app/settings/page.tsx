      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${config.forcePush ? 'bg-[#4d59a3]' : 'bg-[#e7eff5]'}`}
          >
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            ...
            className={`w-14 h-7 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${config.backupBeforePull ? 'bg-[#4d59a3]' : 'bg-[#e7eff5]'}`}
          >
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            aria-label="自动恢复 web.config"
            onClick={() => setConfig({ ...config, autoRestoreWebConfig: !config.autoRestoreWebConfig })}
            className={`w-14 h-7 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${config.autoRestoreWebConfig ? 'bg-[#4d59a3]' : 'bg-[#e7eff5]'}`}
          >
