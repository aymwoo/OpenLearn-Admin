    ...
    <main className="min-h-screen bg-[#f6fafe] p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <span id="forcePush-label" className="text-base text-[#566167]">强制用远端覆盖本地冲突</span>
          <button
            type="button"
            role="switch"
            aria-checked={config.forcePush}
            aria-labelledby="forcePush-label"
            onClick={() => setConfig({ ...config, forcePush: !config.forcePush })}
            className={`w-12 h-6 rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#4d59a3] focus-visible:ring-offset-2 ${config.forcePush ? 'bg-[#4d59a3]' : 'bg-[#e7eff5]'}`}
          >
        ...
        <div className="mb-6 flex items-center justify-between">
          <span id="backupBeforePull-label" className="text-base text-[#566167]">拉取前备份</span>
          <button
            type="button"
            role="switch"
            aria-checked={config.backupBeforePull}
            aria-labelledby="backupBeforePull-label"
            onClick={() => setConfig({ ...config, backupBeforePull: !config.backupBeforePull })}
            className={`w-14 h-7 rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#4d59a3] focus-visible:ring-offset-2 ${config.backupBeforePull ? 'bg-[#4d59a3]' : 'bg-[#e7eff5]'}`}
          >
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex flex-col">
            <span id="autoRestore-label" className="text-base text-[#566167]">自动恢复 web.config</span>
          ...
          <button
            ...
            aria-labelledby="autoRestore-label"
            onClick={() => setConfig({ ...config, autoRestoreWebConfig: !config.autoRestoreWebConfig })}
            className={`w-14 h-7 rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#4d59a3] focus-visible:ring-offset-2 ${config.autoRestoreWebConfig ? 'bg-[#4d59a3]' : 'bg-[#e7eff5]'}`}
          >
